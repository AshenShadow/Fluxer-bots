...
type GatewayInviteCreateDispatchData = APIInvite;
...
declare const Routes: {
    ...
    readonly channelPinMessage: (channelId: Snowflake, messageId: Snowflake) => `/channels/${string}/pins/${string}`;
    ...
    readonly leaveGuild: (guildId: Snowflake) => `/users/@me/guilds/${string}`;
    readonly userMeChannels: () => "/users/@me/channels";
    readonly userProfile: (id: Snowflake) => `/users/${string}/profile`;
    readonly gatewayBot: () => "/gateway/bot";
    readonly streamPreview: (streamKey: string) => `/streams/${string}/preview`;
...
export { type APIApplicationCommandInteraction, type APIApplicationCommandOptionValue, type APIBan, type APIChannel, type APIChannelOverwrite, type APIChannelPartial, type APIEmbed, type APIEmbedAuthor, type APIEmbedChild, type APIEmbedField, type APIEmbedFooter, type APIEmbedMedia, type APIEmoji, type APIEmojiWithUser, type APIErrorBody, APIErrorCode, type APIGatewayBotResponse, type APIGuild, type APIGuildAuditLog, type APIGuildAuditLogEntry, type APIGuildMember, type APIGuildPartial, type APIInvite, type APIMessage, type APIMessageAttachment, type APIMessageCall, type APIMessageReaction, type APIMessageReference, type APIMessageSnapshot, type APIMessageSticker, type APIReactionEmoji, type APIRole, type APISticker, type APIStickerWithUser, type APIUser, type APIUserPartial, type APIWebhook, type APIWebhookTokenUpdateRequest, type APIWebhookUpdateRequest, ChannelType, DefaultMessageNotifications, EmbedMediaFlags, type EmbedType, FLUXER_EPOCH, type GatewayChannelCreateDispatchData, type GatewayChannelDeleteDispatchData, type GatewayChannelPinsUpdateDispatchData, type GatewayChannelUpdateDispatchData, type GatewayCustomStatus, type GatewayDispatchEventName, GatewayDispatchEvents, type GatewayGuildBanAddDispatchData, type GatewayGuildBanRemoveDispatchData, type GatewayGuildCreateDispatchData, type GatewayGuildDeleteDispatchData, type GatewayGuildEmojisUpdateDispatchData, type GatewayGuildIntegrationsUpdateDispatchData, type GatewayGuildMemberAddDispatchData, type GatewayGuildMemberRemoveDispatchData, type GatewayGuildMemberUpdateDispatchData, type GatewayGuildRoleCreateDispatchData, type GatewayGuildRoleDeleteDispatchData, type GatewayGuildRoleUpdateDispatchData, type GatewayGuildScheduledEventCreateDispatchData, type GatewayGuildScheduledEventDeleteDispatchData, type GatewayGuildScheduledEventUpdateDispatchData, type GatewayGuildStickersUpdateDispatchData, type GatewayGuildUpdateDispatchData, type GatewayHelloData, type GatewayIdentifyData, type GatewayInviteCreateDispatchData, type GatewayInviteDeleteDispatchData, type GatewayMessageCreateDispatchData, type GatewayMessageDeleteBulkDispatchData, type GatewayMessageDeleteDispatchData, type GatewayMessageReactionAddDispatchData, type GatewayMessageReactionRemoveAllDispatchData, type GatewayMessageReactionRemoveDispatchData, type GatewayMessageReactionRemoveEmojiDispatchData, type GatewayMessageUpdateDispatchData, GatewayOpcodes, type GatewayPresenceUpdateData, type GatewayPresenceUpdateDispatchData, type GatewayReactionEmoji, type GatewayReadyDispatchData, type GatewayReceivePayload, type GatewayResumeData, type GatewaySendPayload, type GatewayTypingStartDispatchData, type GatewayUserUpdateDispatchData, type GatewayVoiceServerUpdateDispatchData, type GatewayVoiceStateUpdateData, type GatewayVoiceStateUpdateDispatchData, type GatewayWebhooksUpdateDispatchData, GuildExplicitContentFilter, type GuildFeature, GuildMFALevel, GuildVerificationLevel, MessageAttachmentFlags, MessageFlags, MessageType, OverwriteType, type RateLimitErrorBody, Routes, type Snowflake, WebhookType };
